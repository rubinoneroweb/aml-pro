...
class ToolsControllerTest < ActionController::TestCase
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post :create, tool: { description: @tool.description, machine_id: @tool.machine_id, name: @tool.name, picture: @tool.picture }
    end
  ...
  test "should update tool" do
    patch :update, id: @tool, tool: { description: @tool.description, machine_id: @tool.machine_id, name: @tool.name, picture: @tool.picture }
    assert_redirected_to tool_path(assigns(:tool))
  end
